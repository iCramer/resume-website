		...
		$scope.projects = [
			{
				...
				logo: 'zillow.png',
				backgroundImg: 'zillow.jpg',
				projectSummary: 'Zillow Website',
				projectTools: 'Next.js, TypeScript, Styled Components, GraphQL',
				description: `<ul>
			<li>Play a lead front end engineer role on the social impact team</li>
				<li>Lead front end engineering and design on several high impact projects including a feature to
allow renters to report on time payments to the credit beureus</li>
				<li>Guide all engineers on my team in front end best practices in order to raise the quality of code
produced, reduce tech debt, and maximize scalability.</li>
			</ul>`,
			},
			{
				id: '2',
		...
		$scope.showDetails = function (index) {
			...
			$timeout(function () {
				...
				$scope.viewFull = true;
				$('.placeholder > div').css({
					top: $scope.topAlign - 8,
					left: -$scope.leftAlign,
		...
		$scope.hideDetails = function () {
			...
			$('.placeholder > div').css({
				top: $scope.elementTop,
				left: $scope.elementLeft,
				height: $scope.projectHeight,
				width: $scope.projectWidth,
			});
